...
var _1=false;
function _2(e){
var _3=$.data(e.data.target,"_draggable").options;
var _4=e.data;
...
function _7(e){
var _8=$.data(e.data.target,"_draggable").options;
var _9=$.data(e.data.target,"_draggable").proxy;
if(_9){
_9.css("cursor",_8.cursor);
}else{
_9=$(e.data.target);
$.data(e.data.target,"_draggable").handle.css("cursor",_8.cursor);
}
_9.css({left:e.data.left,top:e.data.top});
};
function _a(e){
_1=true;
var _b=$.data(e.data.target,"_draggable").options;
...
$.data(e.data.target,"_draggable").droppables=_c;
var _e=$.data(e.data.target,"_draggable").proxy;
if(!_e){
if(_b.proxy){
if(_b.proxy=="clone"){
...
$.data(e.data.target,"_draggable").proxy=_e;
}else{
_e=$(e.data.target);
}
}
...
_1=false;
_2(e);
var _13=$.data(e.data.target,"_draggable").proxy;
var _14=$.data(e.data.target,"_draggable").options;
if(_14.revert){
if(_15()==true){
_16();
...
$.fn._draggable=function(_19,_1a){
if(typeof _19=="string"){
return $.fn._draggable.methods[_19](this,_1a);
}
return this.each(function(){
var _1b;
var _1c=$.data(this,"_draggable");
if(_1c){
_1c.handle.unbind("._draggable");
_1b=$.extend(_1c.options,_19);
}else{
_1b=$.extend({},$.fn._draggable.defaults,_19||{});
}
...
$.data(this,"_draggable",{options:_1b,handle:_1d});
_1d.unbind("._draggable").bind("mousemove._draggable",{target:this},function(e){
if(_1){
return;
}
var _1e=$.data(e.data.target,"_draggable").options;
if(_1f(e)){
...
$(document).bind("mousedown._draggable",e.data,_a);
$(document).bind("mousemove._draggable",e.data,_f);
$(document).bind("mouseup._draggable",e.data,_12);
$("body").css("cursor",_22.cursor);
});
function _1f(e){
var _23=$.data(e.data.target,"_draggable");
var _24=_23.handle;
var _25=$(_24).offset();
...
_90._draggable("disable");
_90.css("cursor","pointer");
};
function _91(_92){
var _93=$.data(_92,"tree").options;
var _94=$.data(_92,"tree").tree;
_94.find("div.tree-node")._draggable({disabled:false,revert:true,cursor:"pointer",proxy:function(_95){
...
$(_97)._draggable("proxy").removeClass("tree-dnd-no").addClass("tree-dnd-yes");
...
$(_9a)._draggable("proxy").removeClass("tree-dnd-yes").addClass("tree-dnd-no");
$(this).removeClass("tree-node-append tree-node-top tree-node-bottom");
...
_1de.window._draggable({handle:">div.panel-header>div.panel-title",disabled:_1de.options._draggable==false,onStartDrag:function(e){
if(_1de.mask){
...
win.window({title:opts.title,width:opts.width,height:opts.height,collapsible:false,minimizable:false,maximizable:false,shadow:false,_draggable:false,resizable:false,closed:true,onBeforeOpen:function(){
...
_792.find("a.slider-handle")._draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
