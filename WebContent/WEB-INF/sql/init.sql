...
insert into sys_function(FUNCTIONID,FUNCHINESENAME,FUNENGLISHNAME,FUNPATH,FUNORDER,FUNSYSTEM,FUNPARENT,FUNICON) values ('7','权限管理','AUTHORITY','webpage/system/authority/AuthorityMgr.html',4,1,1,'icon-page');
